(function () {
    ...
    var DoctorController = function ($scope, doctorService, $location) {
        ...
        $scope.doctors = [
            {
                Name: "Dr. Debashish Ghosh", Timing: [{ Day: "MON-SUN", TIME: "12.30PM-3.30PM"}]
            ...
            {
                Name: "Dr. Nilanjan Dutta", Timing: [{ Day: "MON-TUE,THU-FRI", TIME: "10.30AM-7.00PM" }, { Day: "WED,SAT", TIME: "6.00P.M-7.00PM"}]
            ...
            {
                Name: "Dr. Arindam Deb", Timing: [{ Day: "TUE,THU,SAT", TIME: "6.00PM-8.00PM"}]
            ...
            {
                Name: "Dr.Sourav Bhattacharya", Timing: [{ Day: "TUE,FRI", TIME: "6.00PM-8.00PM"}]
